...
import com.github.axet.audiorecorder.bottomsheet.ComposeAudioBottomSheet;
import com.github.axet.audiorecorder.bottomsheet.PermissionUtils;
...
public class MainActivity extends AppCompatThemeActivity {
    ...
    private void checkAudioPermission() {
        ...
        if (audioPermission != PackageManager.PERMISSION_GRANTED) {
            ...
            PermissionUtils.requestPermission((AppCompatActivity) MainActivity.this, Manifest.permission.RECORD_AUDIO, REQUEST_RECORD_AUDIO);
        } else {
            audioRecord = true;
        }

        if (filePermission != PackageManager.PERMISSION_GRANTED) {
            PermissionUtils.requestPermission((AppCompatActivity) MainActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE, PERMISSION_REQUEST_WRITE_EXTERNAL);
        } else {
            fileStorage = true;
        }

        if (fileStorage && audioRecord) {
            ComposeAudioBottomSheet composeAudioBottomSheet = new ComposeAudioBottomSheet();
            composeAudioBottomSheet.show(getSupportFragmentManager(),composeAudioBottomSheet.getTag());
        }
    }
    ...
    private void showAlert() {
        ...
        View view = li.inflate(R.layout.view_recording,null);
